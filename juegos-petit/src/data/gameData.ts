...
export const games: Game[] = [
  ...
  {
    id: 'juegos-educativos-regalo-navidad',
    title: '7 Juegos Educativos para Regalar a Niños',
    shortDescription: 'Selección curada de juegos educativos ideales para regalar, que combinan diversión con aprendizaje significativo para diferentes edades y habilidades.',
    detailedDescription: 'Esta colección especial presenta siete juegos educativos cuidadosamente seleccionados por Educación 3.0, perfectos para regalar en cualquier ocasión especial. Incluye desde juegos de detectives que desarrollan la gestión emocional hasta clásicos de lectura y escritura, pasando por actividades que fomentan la creatividad, el pensamiento lógico y las habilidades sociales. Cada juego está diseñado para ser tanto educativo como entretenido, asegurando que los niños aprendan mientras se divierten. La selección abarca diferentes rangos de edad y tipos de aprendizaje, desde juegos cooperativos hasta desafíos individuales que estimulan el desarrollo cognitivo.',
    image: 'https://www.educaciontrespuntocero.com/wp-content/uploads/2017/12/juegos-educativos-978x652.jpg',
    difficulty: 'Variado (Fácil-Intermedio)',
    participants: '1-6 jugadores',
    duration: '30-90 minutos por juego',
    ageGroup: '3-12 años',
    tags: ['Educativo', 'Regalo', 'Desarrollo Cognitivo', 'Habilidades Sociales', 'Lectura', 'Emocional'],
    category: ['Educación Integral', 'Desarrollo Infantil', 'Juegos de Mesa'],
    author: 'Educación 3.0',
    type: 'Colección de Juegos Educativos',
    whatYouWillLearn: [
      'Desarrollar habilidades de lectura y escritura',
      'Gestionar emociones y desarrollar empatía',
      ...
      'Estimular la curiosidad y el amor por el aprendizaje',
      'Construir confianza en las propias capacidades'
    ],
    materials: [
      'Juegos de mesa educativos seleccionados según la edad',
      'Instrucciones claras en español',
      'Materiales de calidad y seguros para niños',
      'Guías para padres y educadores',
      'Espacio adecuado para jugar',
      'Tiempo dedicado para la actividad',
      'Actitud positiva y paciencia para el aprendizaje'
    ]
  }
];